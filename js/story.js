var story = ["웨일은 태어나기 전 마음속으로 긴 카운트를 세었습니다. 1년, 2년, 3년, 4년, 그리고 마지막 5년이 되던 날 웨일은 깨어날 준비를 마쳤습니다.",
    ...
    "오늘도 웨일은 더 큰 고래가 되기 위해 브라우저탭을 먹으며 당신도 더 큰 사람이 될 수 있도록 밥을 꼭꼭 챙겨먹기를 바랐습니다.",
...
$(document).ready(function () {
    ...
    Button.creatButton(whaleNum); // 스토리버튼 생성
